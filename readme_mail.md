...
- Добавил сеть, каждому пользователю свое соединение, чтобы не было перебоев в сообщениях. Мне не совсем ясно, как будет устренно обращение к базе данных в сети, есть над чем подумать. Возможно добавить докер, короче нужны пояснения...
...
Что можно отметить? 
- Возможны sql инъекции, можно чутка поменять код, чтобы это запретить. 
