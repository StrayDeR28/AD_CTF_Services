...
# При внедрении функции добавления подписи (ImgEncrypt):
# 1. Переписать используемые библиотеки
# 2. Сопоставить имя функции и имена аргументов
# 3. Поменять путь, откуда берется картинка
# 4. Поменять путь, куда сохраняется картинка
